---
title: Contrôler les délivrances
description: Étapes simples pour contrôler les délivrances dans LEO.
---
...
4. Sélectionnez le type de liste, définissez les critères si nécessaire, puis lancez la recherche des factures.
    
5. Cliquez sur **Contrôler** pour afficher l’écran de **contrôle délivrance/délivré**.
